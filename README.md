...
b)python cifar_pretrain.py -l 56 --save_dir ./cifarmodel --epochs 164 --batch-size 128 --lr 0.1 --momentum 0.9 --wd 1e-4
...
Steps:(for ResNet56)
c)mv cifarmodelresnet56.pkl cifarmodel/resnet56.pkl
##g = 2,3,4
